        ...
        for direction, url in endpoints:
            ...
            try:
                ...
                if res.status_code == 200:
                    ...
                    # Se404, significa semplicemente nessun volo trovato per questo intervallo
                    pass
...
def add_interest():
    ...
    #Se matched_count > 0, significa che ha trovato un documento esistente -> Aggiornamento
    if result.matched_count > 0:
        message = f"Soglie aggiornate per l'aeroporto d'interesse {code} per l'utente {email}"
        status_code = 200
    else:
        #Altrimenti è stato creato un nuovo documento -> Inserimento
